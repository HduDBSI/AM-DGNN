...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default="taggcn", help="model")
    parser.add_argument('--data_root', type=str, default=r"/home/yhj/data", help="root data path")
    parser.add_argument('--dataset', type=str, default='lastfm', help='data set')
    ...
    parser.add_argument('--reg', type=float, default=0.0001, help="the learning rate")
    parser.add_argument('--cor_reg', type=float, default=0, help="the learning rate")

    parser.add_argument('--epochs', type=int, default=1000)
    parser.add_argument('--dim_latent', type=int, default=128, help="the latent embedding size of the model")
    parser.add_argument('--dim_layer_list', nargs='?', default="[128,128,128]", help="embedding size of each layer")
